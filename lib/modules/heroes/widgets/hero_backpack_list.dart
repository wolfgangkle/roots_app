  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final backpack =
            List<Map<String, dynamic>>.from(data['backpack'] ?? []);
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final stats =
                    item['craftedStats'] as Map<String, dynamic>? ?? {};
